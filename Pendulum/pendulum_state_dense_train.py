...
inputX = data[:,:5].astype('float64')
inputY = data[:,5:9].astype('float64')
print(inputX.shape)
print(inputY.shape)
...
model.save('Pend_State_Dense_Network.keras')
print(model.summary())

np.save("history_Pend_State_Dense_Network.npy", history.history, allow_pickle=True)